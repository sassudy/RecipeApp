...
public class RequestManager {
    ...
    public void getRecipeDetails(RecipeDetailsListener listener, int id){
        ...
        call.enqueue(new Callback<RecipeDetailsResponce>() {
            @Override
            public void onResponse(Call<RecipeDetailsResponce> call, Response<RecipeDetailsResponce> response) {
                if (!response.isSuccessful()){
                    listener.didError(response.message());
                    return;
                }
            ...
            @Override
            public void onFailure(Call<RecipeDetailsResponce> call, Throwable t) {
                listener.didError(t.getMessage());
            }
        });
    }
